...
[Docs Dashboard](https://yuhandemian.github.io/CKArena/) | [Dashboard Plan](docs/product/DASHBOARD_PLAN.md)
...
`dashboard/`는 `docs/`를 원본 지식 저장소로 읽어 프로젝트 진행 상황과 Harness Engineering 흐름을 시각화하는 React 기반 정적 웹 문서입니다.

배포 주소:
```text
https://yuhandemian.github.io/CKArena/
```
...
`main`에 `docs/**` 또는 `dashboard/**` 변경이 반영되면 GitHub Actions가 dashboard를 빌드하고 GitHub Pages에 배포합니다.
