...
## 전체 구조
CKArena는 React 프론트엔드와 Spring Boot 백엔드를 사용한다. 프론트엔드는 REST API를 통해 백엔드와 통신하고, 채팅 기능은 WebSocket(STOMP)으로 구현한다.
...
- Database: MySQL. 사용자, 게스트 세션, 채팅 메시지, 리뷰, 뉴스 메타데이터, 좋아요, 댓글 저장.
